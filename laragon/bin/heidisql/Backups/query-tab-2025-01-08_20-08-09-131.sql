CREATE DATABASE IF NOT EXISTS db_inventory1 
USE db_inventory1;
...
WHERE `product_name` NOT IN ('Arroz blanco de grano largo', 'Whisky escocés');
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `branch_id`, `role_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(12, 'Alex Mauricio Callatasig Toasa', 'alexcallatasig1@gmail.com', '$2y$10$W/nqTuN0X.JaGtGBkpw01OTSL0I3aShYL9QusP8Q5kIZ2AviqQHKC', 1, 2, '6zd4CxMA9RCTnuJaxtyhByrBYJsPfV9GtAB4pJE3Ht6YTsIvQ7ETjUVO1jlv', '2020-07-31 17:27:25', '2023-04-17 05:20:18');
